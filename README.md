...
```text
docs/delion/system-requirements.md
```
...
```text
docs/delion/business-requirements/BR-001.md
```

```text
/deli:validate system
/deli:validate feature BR-001
/deli:validate file docs/delion/business-requirements/BR-001.md --type business
```
...
```text
/deli:run-file BR-001 docs/delion/business-requirements/BR-001.md --base master
```

Запускает workflow только по валидированному файлу бизнес-требований.
