...
```powershell
python "$HOME/.gigacode/extensions/delion/main.py" \deli:validate feature FEATURE_KEY
```

Для произвольного файла выполни:

```powershell
python "$HOME/.gigacode/extensions/delion/main.py" \deli:validate file path/to/requirements.md --type auto
```
